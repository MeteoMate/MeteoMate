    ...
    return (
        <div>
            ...
            <div className={"modalInfo"}>
                ...
                <p>In the year 2024, this application was extended by Alexey Buyakofu, Andreas Huwiler and Dario Küffer as a master project for the <a href="https://www.ifi.uzh.ch/en.html" target="_blank" title="ifi" rel="noreferrer">Department of Informatics for the University of Zurich</a>.</p>
